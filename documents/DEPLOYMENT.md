...
# should say - Installed XX object(s) from X fixture(s)
```
...
2) A Procfile to run the webserver i.e. `web: gunicorn all_tours.wsgi` 
...
- Navigate to the repository for this project [all_tours](https://github.com/JennyDelaney/pp5-JennyDelaney)
